...
public class CameraFollow : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        this.transform.position = new Vector3(0, player.transform.position.y, radius);

        _rotationPoint.transform.LookAt(new Vector3(player.transform.position.x, 0, player.transform.position.z));
